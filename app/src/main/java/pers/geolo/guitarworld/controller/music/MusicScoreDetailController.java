 ...
 * @date 2019/7/10
 */
public class MusicScoreDetailController extends SwipeBackController {
    ...
    public static MusicScoreDetailController newInstance(long musicScoreId) {

        Bundle args = new Bundle();
        args.putLong(MUSIC_SCORE_ID, musicScoreId);
        MusicScoreDetailController fragment = new MusicScoreDetailController();
