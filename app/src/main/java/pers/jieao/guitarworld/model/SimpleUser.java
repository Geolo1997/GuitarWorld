...
public class SimpleUser extends User {
    ...
    public SimpleUser(String id, String password, List<Long> attentionList, List<Long> fansList) {
        super(id, password);
        this.attentionList = attentionList;
        this.fansList = fansList;
    }

    public int sendMessage(String receiverId, MessageContent messageContent) {
